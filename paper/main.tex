...
\begin{table}[h]
\caption{Comparison of XSS Detection Systems}
\centering
\begin{tabular}{lcccc}
\toprule
...
Offline BNB (char n-gram) & TBD & TBD & TBD & TBD ms \\
\textbf{AdaptXSS (cold)} & TBD & TBD & TBD & $<$5 ms \\
\textbf{AdaptXSS (warm)} & TBD & TBD & TBD & $<$5 ms \\
\bottomrule
\end{tabular}
\end{table}
...
Figure~\ref{fig:drift} shows F1 across 5 simulated sessions of 100 mutations each. The online update rule stabilises or improves F1 with each new session, validating the incremental learning design.
